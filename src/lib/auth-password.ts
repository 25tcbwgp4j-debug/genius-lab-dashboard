// Autenticazione dashboard Genius Lab: sign/verify HMAC token per cookie sessione.
// Usa Web Crypto API per essere compatibile con l'Edge runtime del proxy.
// Stesso pattern della dashboard Tarature (auth.ts), rinominato per evitare
// conflitto con il file src/lib/auth/ esistente (session Supabase legacy).

export const AUTH_COOKIE_NAME = "gl-auth";
